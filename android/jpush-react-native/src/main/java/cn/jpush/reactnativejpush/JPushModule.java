...
public class JPushModule extends ReactContextBaseJavaModule implements LifecycleEventListener {
    ...
    public void clearAllNotifications() {
        ...
        BadgeUtil.resetBadgeCount(mContext, R.drawable.ic_launcher);
    }
    ...
    @ReactMethod
    public void setBadge(int count, Callback callback) {
        int sequence = getSequence();
        sCacheMap.put(sequence, callback);
        Logger.i(TAG, " count: " + count + " sequence: " + sequence);
        BadgeUtil.setBadgeCount(getReactApplicationContext(), count, R.drawable.ic_launcher);
    }
