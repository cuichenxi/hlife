...
const selted = require('../img/selted.png');
class Raio2 extends Component{
    ...
    render(){
        const imgUrl=this.props.hightlight?this.props.seledImg||require('../img/selted.png'):this.props.selImg||require('../img/selt.png');
        const imgUrlNone=this.props.selnoneImg||require('../img/seltnone.png');
        return(
            <TouchableHighlight
