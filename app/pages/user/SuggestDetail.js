...
export default class ComplaintDetail extends BaseComponent {
    ...
    requestData() {
        ...
        this.showLoading()
        Request.post('/api/steward/consultsuggestInfo', param).then(rep => {
            ...
            <View style={{flex: 1}}>
                <ScrollView style={{
                    ...
                    <View style={{
                        ...
                        {
                            data.status === 1?<View style={{flexDirection: 'row', marginTop: 10}}>
                    ...
                    <View style={{marginTop: 15, backgroundColor: '#fff', paddingLeft: 15}}>
                        <Text style={{fontSize: 16, color: '#333', height: 40, textAlignVertical: 'center'}}>咨询建议</Text>
