...
export default class SuggestList extends BaseComponent{
    navigationBarProps() {
        return {
            title: '咨询建议',
        }
    ...
    makeRemoteRequest(page = 1, callback) {
        ...
        Request.post('/api/steward/consultsuggestList', param,
            {
                mock: false,
                mockId: 1095356,
            }).then(rep => {
    ...
    _renderRowView(item) {
        return (
            <TouchableView onPress={() => {
                this.navigate("SuggestDetail", item)
            }}>
                <View style={{
                    ...
                    <View style={{flexDirection: 'row', justifyContent: 'center', alignItems: 'center'}}>
                        <ImageView defaultSource={require("../../img/menu_zxjy.png")} style={{
                            width: 27,
